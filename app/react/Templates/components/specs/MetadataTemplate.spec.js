...
import { MetadataTemplateComponent, dropTarget } from 'app/Templates/components/MetadataTemplate';
...
describe('MetadataTemplate', () => {
  function renderComponent(ComponentToRender, _props = {}, properties = []) {
    const props = _props;
