...
export default {
  entities: [
    { _id: db.id(), sharedId: batmanFinishes, template: template1, language: 'en', title: 'Batman finishes en', fullText: { 1: 'english[[12]] document[[2]] english[[123]]' }, published: true, user: userId },
    { _id: db.id(), sharedId: batmanFinishes, template: template1, language: 'es', title: 'Batman finishes es', fullText: { 1: 'spanish[[34]] document[[4]]' }, published: true, user: userId },
    { _id: db.id(), sharedId: batmanBegins, template: template2, language: 'en', title: 'Batman begins en', fullText: { 1: 'english[[2]] another[[5]]' }, published: true, user: userId },
