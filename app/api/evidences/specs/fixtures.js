...
export default {
  ...
  templates: [
    {_id: templateId, name: 'template_test', properties: [
      ...
      {type: 'multiselect', name: 'multiselect', _id: propertyID1, property: propertyID1}
    ]},
    {_id: db.id(), name: 'template_test2', properties: [
      {type: 'text', name: 'text', _id: db.id()},
      {type: 'multiselect', name: 'multiselect', _id: propertyID2, content: propertyID2}
    ]}
  ],
  dictionaries: [
    {_id: db.id(), name: 'dictionaty1', values: [
      {id: value1, label: 'dict1', _id: db.id()},
      {id: value2, label: 'dict2', _id: db.id()}
    ]},
    {_id: db.id(), name: 'dictionary2', values: [
